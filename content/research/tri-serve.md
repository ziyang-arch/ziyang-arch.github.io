---
title: "Tri-serve: Energy-Efficient Multimodal Inference Serving"
date: 2026-08-07
weight: 1
tags: [Multimodal LLM, Inference Serving, GPU Power Management, Energy Efficiency]
summary: "A serving system that coordinates workload-aware GPU power management across the multimodal (Thinker/Talker/Vocoder) pipeline to cut serving energy with negligible latency impact."
---
...
Tri-serve identifies three inefficiency sources in multimodal serving pipelines:
...
Tri-serve coordinates DVFS decisions *across* the pipeline rather than per-GPU in isolation: it sets each stage's frequency based on its workload phase, its position in the dependency chain, and the available thermal headroom, keeping end-to-end latency (TTFT/TPOT and audio real-time factor) within SLO while eliminating wasted boost energy.

## Results

On Qwen2.5-Omni serving workloads, Tri-serve reduces serving energy by double-digit percentages with negligible latency impact compared to default auto-boost operation.

## Links

- Paper: [arXiv:2606.29629](https://arxiv.org/abs/2606.29629) (under review at ICCD 2026)
